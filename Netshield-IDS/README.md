...
*Signature-based precision meets anomaly-based instinct.*
...
[![Snort](https://img.shields.io/badge/Snort-Signature%20Engine-CC0000?style=for-the-badge&logo=snort&logoColor=white)](https://www.snort.org/)
[![License](https://img.shields.io/badge/License-MIT-4CAF50?style=for-the-badge)](LICENSE)

`⬤ PCAP Analysis`  `⬤ Snort Rules`  `⬤ Anomaly Detection`  `⬤ Live Dashboard`  `⬤ Auto-Blocking`
...
Built for home labs, coursework, and SOC-style demos where you need a hybrid detection story without standing up a full enterprise stack.
...
|---|---|
| 🛰️ **PCAP Traffic Analysis** | Parses offline network captures via Tshark |
...
| 🧩 **Unified Alert System** | Merges Snort + anomaly alerts with severity classification |
| 🖥️ **Real-Time Dashboard** | Live alerts, charts, and attack timeline |
...
│   ├── static/                → CSS theme + real-time JS charts
│   └── templates/              → Dashboard HTML
├── snort_rules/
│   └── custom.rules           → 30+ Snort detection rules
├── sample_pcaps/               « Sample captures (bring your own too)
...
Then point `backend/config.py` at your local binaries if they're not on PATH:
...
| DDoS | >50 unique sources → one host |
